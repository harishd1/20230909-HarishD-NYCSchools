...
class SchoolListViewController: UIViewController {
    ...
    var nycHSList: [SchoolModel]?
    
    var filteredNycHSList = [SchoolModel]()
    ...
    func filterContentForSearchText(_ searchText: String, scope: String = "All") {
        filteredNycHSList = (nycHSList?.filter({( schools : SchoolModel) -> Bool in
    ...
    @objc func callNumber(_ sender: UIButton){
        ...
        var nycHighSchoolList: SchoolModel
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == Constants.HSWithSATScoreSegue{
            ...
            if let highSchoolWithSATScore = sender as? SchoolModel {
